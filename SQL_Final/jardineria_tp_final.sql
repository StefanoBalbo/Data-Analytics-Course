...
SELECT pais, ciudad, codigo_oficina, telefono FROM oficina WHERE pais = "España";
...
SELECT nombre, CONCAT(apellido1, " ", apellido2) AS apellido, email 
...
SELECT * 
FROM cliente;
SELECT DISTINCT a.codigo_cliente, b.nombre_cliente, a.fecha_pago FROM pago a 
JOIN cliente b ON a.codigo_cliente = b.codigo_cliente WHERE LEFT (a.fecha_pago, 4) = "2008";

SELECT * 
FROM pedido;
SELECT codigo_pedido, codigo_cliente, fecha_esperada, estado FROM pedido 
WHERE estado = "Rechazado" AND LEFT (fecha_esperada, 4) = "2009";

SELECT * 
FROM producto;

SELECT codigo_producto, gama, cantidad_en_stock, precio_venta FROM producto
WHERE cantidad_en_stock > 100 AND gama = "Ornamentales" ORDER BY precio_venta DESC;
...
SELECT a.nombre_cliente, b.nombre AS nombre_rv,
b.apellido1 AS apellido1_rv,
b.apellido2 AS apellido2_rv FROM cliente a JOIN empleado b 
ON a.codigo_empleado_rep_ventas = b.codigo_empleado WHERE b.puesto = "Representante Ventas";

SELECT puesto, COUNT(email) AS cantidad_empleados FROM empleado GROUP BY puesto;

SELECT a.nombre_cliente, b.nombre AS nombre_rv,
b.apellido1 AS apellido1_rv,
b.apellido2 AS apellido2_rv FROM cliente a LEFT JOIN empleado b 
ON a.codigo_empleado_rep_ventas = b.codigo_empleado WHERE b.puesto = "Representante Ventas" OR b.puesto IS NULL;
